...
export const permissions = {
  ...
  createRealEstateProperty: 'createRealEstateProperty',
  createRealEstatePropertyValuation: 'createRealEstatePropertyValuation',
  createMortgage: 'createMortgage',
  createMortgageAmortization: 'createMortgageAmortization',
  ...
  deleteRealEstateProperty: 'deleteRealEstateProperty',
  deleteRealEstatePropertyValuation: 'deleteRealEstatePropertyValuation',
  deleteMortgage: 'deleteMortgage',
  deleteMortgageAmortization: 'deleteMortgageAmortization',
  ...
  updateRealEstateProperty: 'updateRealEstateProperty',
  ...
  switch (aRole) {
    case 'ADMIN':
      return [
        ...
        permissions.createRealEstateProperty,
        permissions.createRealEstatePropertyValuation,
        permissions.createMortgage,
        permissions.createMortgageAmortization,
        ...
        permissions.deleteRealEstateProperty,
        permissions.deleteRealEstatePropertyValuation,
        permissions.deleteMortgage,
        permissions.deleteMortgageAmortization,
        ...
        permissions.updateRealEstateProperty,
        permissions.updateMortgage,
