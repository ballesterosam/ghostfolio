...
const TASK_PATTERNS = [
  ...
  {
    tokens: ['review', 'audit', 'check', 'validate', 'security'],
    agent: 'reviewer'
  },
  {
    tokens: ['research', 'find', 'search', 'documentation', 'explore'],
    agent: 'researcher'
  },
  {
    tokens: ['design', 'architect', 'architecture', 'structure', 'plan'],
    agent: 'architect'
  },

  // Domain patterns
  {
    tokens: ['api', 'endpoint', 'server', 'backend', 'database'],
    agent: 'backend-dev'
  },
  {
    tokens: ['ui', 'frontend', 'component', 'react', 'css', 'style'],
    agent: 'frontend-dev'
  },
